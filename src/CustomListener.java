...
public class CustomListener extends MicroBaseListener {
    ...
    ******************************************************/
    ...
    public void basicBlocks(){
        ...
        for (Ircode i: leaders){
        	//System.out.println(i.printCode());
        	i.printCode();
        }
